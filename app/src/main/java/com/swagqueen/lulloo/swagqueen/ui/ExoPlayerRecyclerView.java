package com.swagqueen.lulloo.swagqueen.ui;
...
import com.swagqueen.lulloo.swagqueen.adapter.PlayerViewHolder;
...
public class ExoPlayerRecyclerView extends RecyclerView {
   ...
   */
  private ImageView mediaCoverImage, volumeControl,fullscreen;
...
//youtub video url
    //22-360,18-480,137-1080 px
      ...
      mExtractor.extract(mediaObjects.get(targetPosition).getUrl(), true, true);


  }

  private void playVideo1(String downloadUrl) {
    DataSource.Factory dataSourceFactory = new DefaultDataSourceFactory(
            context, Util.getUserAgent(context, AppName));
    ...
    if (volumeControl != null) {
      ...
      if (volumeState == VolumeState.OFF) {
        ...
        requestManager.load(R.drawable.ic_volume_on)
            .into(volumeControl);
        requestManager.load(R.drawable.exo_controls_fullscreen_enter)
            .into(fullscreen);
      }
